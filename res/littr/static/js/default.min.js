...
new Date;!h&&e(c.html())&&a.getTime()-i.getTime()>j&&c.fresheditor("save",function(a,b){var c={action:"save",content:b,auth_token:f};$.ajax({url:"/",dataType:"json",type:"post",data:c,beforeSend:function(){m=new Date;h=!0;k=c.content},success:function(a){a.status!="ok"&&console.debug("Err: "+a.message)},complete:function(){h=!1;i=new Date;var a=i.getTime()-m.getTime(),b=2;a>1E3?b=1:a<400?b=10:a<100&&(b=20);j=a*b}})})}var c=$("#content"),j=3E3,m=new Date,i=new Date,n=$("<div/>").addClass("feedback").insertBefore(c),
g=$("<a/>").addClass("icon").appendTo(n).hide();$(".feedback").mouseenter(function(){$(this).children("a").fadeIn("slow")}).mouseleave(function(){$(this).children("a").fadeOut("slow")});g.click(function(){var a=prompt("Please enter the secret key for this page.","");a!=null&&($(this).hasClass("unlocked")?b(a,"update"):b(a,"check"))});var f=null,k=c.html(),h=!1;b();c.fresheditor().keyup(function(a){var b=[27,83,90],c=[16],a=a.ctrlKey&&b.indexOf(a.keyCode)!=-1?!0:a.shiftKey&&c.indexOf(a.keyCode)!=-1?
!0:[8,9,13,32,46,190].indexOf(a.keyCode)!=-1?!0:!1;a&&l()});setInterval(function(){l()},j)});